            ...
            <div className="container">
                <div className="row mt-5">
                    <div className="col-md-3">
                        ...
                        <h4 className="mb-4 theme-color">Important Links</h4>
                            <ul>
                                <li><Link to="/blog">Blog</Link></li>
                                <li><Link to="/service">Android Development</Link></li>
                                <li><Link to="/service">iOS Development </Link></li>
                    ...
                    <div className="col-md-3">
                        <div className="footer-block footer-block-2">
                            <h4 className="mb-4 theme-color">More From Us</h4>
                            <ul>
                                <li><Link to="/service">Graphics Desing</Link></li>
                                <li><Link to="/service">Social Media Marketing</Link></li>
                    ...
                    <div className="col-md-3">
                        <div className="footer-block footer-block-3">
                            ...
                            <ul>
                            <li><Link to="/service">Wordpress Website</Link></li>
                                <li><Link to="/service">Shopify Store</Link></li>
                                <li><Link to="/service">React Application </Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-3">
