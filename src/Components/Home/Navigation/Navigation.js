...
const Navigation = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light" style={{background : '#dddddd26',boxShadow : '2px 3px 5px #eee'}}>
            <Link to="/"><img src={logo} alt="FN Tech Logo"  style={{maxHeight : '75px'}}/></Link>
